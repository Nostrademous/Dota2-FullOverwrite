...
module( "locations", package.seeall )
...
function GoToRoshan(bot)
	bot:Action_MoveToLocation(ROSHAN);
end

function GoToFountain(bot)
	if ( GetTeam() == TEAM_RADIANT ) then
		bot:Action_MoveToLocation(RAD_FOUNTAIN);
	else
		bot:Action_MoveToLocation(DIRE_FOUNTAIN);
	end
end

for k,v in pairs( locations ) do _G._savedEnv[k] = v end
