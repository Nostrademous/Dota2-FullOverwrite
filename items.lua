...
X["item_aghs_scepter"] = { "item_point_booster", "item_staff_of_wizardry", "item_blade_of_alacrity", "item_ogre_axe" }
...
X["item_bloodstone"] = { X["item_soul_ring"], "item_point_booster", "item_vitality_booster", "item_energy_booster", "item_recipe_bloodstone" }
...
X["item_boots_of_travel_2"] = { "item_boots", "item_recipe_travel_boots", "item_recipe_travel_boots" }
...
X["item_crystalys"] = { "item_broadsword", "item_blades_of_attack", "item_recipe_lesser_crit" }

X["item_daedalus"] = { "item_demon_edge", "item_lesser_crit", "item_recipe_greater_crit" }

X["item_dagon_1"] = { X["item_null_talisman"], "item_staff_of_wizardry", "item_recipe_dagon" }

X["item_dagon_2"] = { X["item_null_talisman"], "item_staff_of_wizardry", "item_recipe_dagon", "item_recipe_dagon" }

X["item_dagon_3"] = { X["item_null_talisman"], "item_staff_of_wizardry", "item_recipe_dagon", "item_recipe_dagon", "item_recipe_dagon" }

X["item_dagon_4"] = { X["item_null_talisman"], "item_staff_of_wizardry", "item_recipe_dagon", "item_recipe_dagon", "item_recipe_dagon", "item_recipe_dagon" }

X["item_dagon_5"] = { X["item_null_talisman"], "item_staff_of_wizardry", "item_recipe_dagon", "item_recipe_dagon", "item_recipe_dagon", "item_recipe_dagon", "item_recipe_dagon" }
...
X["item_diffusal_blade_2"] = { "item_blade_of_alacrity", "item_blade_of_alacrity", "item_robe", "item_recipe_diffusal_blade", "item_recipe_diffusal_blade" }

X["item_dragon_lance"] = { "item_boots_of_elves", "item_boots_of_elves", "item_ogre_axe" }

X["item_drums_of_endurance"] = { X["item_bracer"], "item_wind_lace", "item_sobi_mask", "item_recipe_ancient_janggo" }

X["item_echo_sabre"] = { X["item_oblivion_staff"], "item_ogre_axe" }

X["item_ethereal_blade"] = { "item_ghost", "item_eagle" }

X["item_euls"] = { "item_staff_of_wizardry", "item_wind_lace", "item_void_stone", "item_recipe_cyclone" }

X["item_eye_of_skadi"] = { "item_point_booster", "item_orb_of_venom", "item_ultimate_orb", "item_ultimate_orb" }
...
X["item_linken_sphere"] = { X["item_pers"], "item_ultimate_orb", "item_recipe_sphere" }
...
X["item_shadow_blade"] = { "item_shadow_amulet", "item_claymore" }

X["item_shivas_guard"] = { "item_platemail", "item_mystic_staff", "item_recipe_shivas_guard" }

X["item_silver_edge"] = { X["item_shadow_blade"], "item_ultimate_orb", "item_recipe_silver_edge" }

X["item_skull_basher"] = { "item_javelin", "item_belt_of_strength", "item_recipe_basher" }
...
X["item_veil_of_discord"] = { X["item_null_talisman"] , "item_null_talisman", "item_helm_of_iron_will", "item_recipe_veil_of_discord" }
